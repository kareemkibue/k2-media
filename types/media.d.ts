...
declare const respond: (minWidth: string, maxWidth: string) => string | undefined;
declare const respondMin: (minWidth: string) => string;
declare const respondMax: (maxWidth: string) => string;
